                ...
                <tbody>
                    ...
                    <td align="center" valign="top">
                        ...
                        <tbody>
                            <tr>
                            <td align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#0088CC !important;color:#fff;border-bottom:0;font-weight:bold;line-height:100%;vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;border-radius:3px 3px 0 0" bgcolor="#4d0322">
                                <tbody>
                                    <tr>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" style="width:100%;vertical-align:top;margin-bottom:40px;padding:0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <address style=""> 
                                                                ...
                                                                Subject: 
                                                                <a href="tel:{{ $subjectData }}" style="color:#4d0322;font-weight:normal;text-decoration:underline" target="_blank">
                                                                    {{ $subjectData }}
                                                                </a> <br><br>
                                                                Message: {{ $content }} <br>
                                                            </address>
