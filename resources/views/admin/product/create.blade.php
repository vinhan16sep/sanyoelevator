                        ...
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('store-product') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{ $errors->has('product_category_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control w-30" name="product_category_id" value="{{ old('product_category_id') }}" id="selectType">
                                        ...
                                        @foreach ($activedProductCategories as $item)
                                            <option value="{{$item['id']}}" {{ old('product_category_id') == $item['id'] ? 'selected' : '' }}>{{$item['title_en']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_en" class="form-control txt-area-content" id="txtareaContentEn">{{ old('content_en') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_jp" class="form-control txt-area-content" id="txtareaContentJp">{{ old('content_jp') }}</textarea>
                                    @if ($errors->has('content_jp'))
                                        <span style="color:red;">{{ $errors->first('content_jp') }}</span>
                                    @endif
                                </div>
