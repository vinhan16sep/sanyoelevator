                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('store-project-category') }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                ...
                                <a type="button" href="{{ route('list-project-category') }}" class="btn btn-default btn-outline"><i class="ti-back-left icon-black"></i>&nbsp;&nbsp;Back</a>
