        ...
        <div class="col-lg-8 p-r-0 title-margin-right">
            <div class="page-header">
                <div class="page-title">
                    <h1>Product categories</span></h1>
                    <a class="btn btn-success btn-flat" href="{{ route('create-product-category') }}"><i class="ti-plus"></i> Create</a>
                </div>
            </div>
        </div>
        <!-- /# column -->
                                    ...
                                    @foreach ($list as $key => $item)
                                        <tr>
                                            ...
                                            <td class="color-primary">
                                                ...
                                                @if ($item->is_active == '1')
                                                <button type="button" class="btn btn-default btn-flat m-l-5 my-list-btn" onclick="changeStatus('{{ $item->id }}', '0', '/product-category/change-status')">
                                                    <i class="ti-control-pause"></i>
                                                </button>
                                                @else
                                                <button type="button" class="btn btn-default btn-flat m-l-5 my-list-btn" onclick="changeStatus('{{ $item->id }}', '1', '/product-category/change-status')">
