                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('update-about', ['id' => $object->id]) }}">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    <label>Value</label>
                                    <textarea name="value" class="form-control txt-area-content" rows="5">{{ old('value', $object->value) }}</textarea>
                                </div>

                                <a type="button" href="{{ route('list-about') }}" class="btn btn-default btn-outline"><i class="ti-back-left icon-black"></i>&nbsp;&nbsp;Quay lại</a>
