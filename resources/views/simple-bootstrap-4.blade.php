@if ($paginator->hasPages())
    <ul class="pagination float-end">
        ...
        @if ($paginator->onFirstPage())
            <li class="page-item border_show disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                <span class="page-link" aria-hidden="true"><i class="fas fa-angle-left"></i></span>
            </li>
        @else
            <li class="page-item border_show">
        ...
        @else
            <li class="page-item border_show disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
