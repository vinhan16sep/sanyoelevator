...
class BusinessController extends AdminController
{
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $model->sub_title_en = $request->input('sub_title_en');
            $model->sub_title_jp = $request->input('sub_title_jp');
            ...
            if ($model->save()) {
                DB::commit();
                return redirect()->route('list-business')->with('success', Config::get('constants.MESSAGE.CREATE_SUCCEEDED'));
            }
            DB::rollBack();
            return redirect()->route('create-business')->with('error', Config::get('constants.MESSAGE.SOMETHING_ERROR'));

        } catch (Exception $e) {
            DB::rollBack();
            return redirect()->route('create-business')->with('error', $e->getMessage()); 
        }
    }
    ...
    public function edit($id) {
        ...
        if ($object == null || $object->count() == 0) {
            return redirect()->route('list-business')->with('error', Config::get('constants.MESSAGE.DATA_NOT_FOUND'));
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $object->sub_title_en = $request->input('sub_title_en');
            $object->sub_title_jp = $request->input('sub_title_jp');
            ...
            if ($object->save()) {
                ...
                return redirect()->route('list-business', $params)->with('success', Config::get('constants.MESSAGE.UPDATE_SUCCEEDED'));
            }
            DB::rollBack();
            return redirect()->route('edit-business', [
                'id' => $id, 
    ...
    public function delete(Request $request) {
        ...
        try {
            ...
            $object = Business::find($request['id']);
